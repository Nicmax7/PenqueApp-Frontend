...
@Component({
  ...
  templateUrl: './pencaIndividualEmpresa.component.html',
  styleUrls: ['./pencaIndividualEmpresa.component.css'],
})
export class PencaIndividualEmpresaComponent implements OnInit {
  dtpenca!: DtPenca;
  puntajes!: DtPuntaje[];
  pageNumber: number = 0;
  ...
  public dataSource: MatTableDataSource<DtCompetencia> =
    new MatTableDataSource();
  competencias: DtCompetencia[] = [];
  public show: boolean = false;
  public buttonName: any = 'Ver competencias';
  ...
  toggle() {
    this.show = !this.show;
    if (this.show) this.buttonName = 'Ocultar';
    else this.buttonName = 'Ver competencias';
  }
